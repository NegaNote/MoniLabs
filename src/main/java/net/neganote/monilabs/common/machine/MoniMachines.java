...
public class MoniMachines {
    ...
    public static MultiblockMachineDefinition VIRTUAL_PARTICLE_SYNTHESIZER = REGISTRATE
            ...
            .recipeModifiers(MoniRecipeModifiers::greenhouseOCasParallels,
                    MoniRecipeModifiers::VirtualParticleSynthesisModifier)
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("C",
                            Predicates
                                    ...
                                    .or(Predicates.machines(ADVANCED_QUANTUM_FLUCTUATION_SENSOR_HATCH)
                                            .setPreviewCount(1)))
