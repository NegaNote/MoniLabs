...
public class PrismFX extends TextureSheetParticle {
    ...
    public static class SetColor
        ...
        public SetColor(SpriteSet spriteSet) {
        ...
        public static void setColor(float... rgb) {
            SetColor.RGB = rgb;
        }
    ...
    public static class PositionalColor
        ...
        public static void initPride() {
            ...
            pride_flags
                    .add(new int[] { 0x5BCEFA, 0xF5A9B8, 0xFFFFFF, 0xF5A9B8, 0x5BCEFA }); // transgender
            pride_flags
                    .add(new int[] { 0xFF76A4, 0xFFFFFF, 0xC011D7, 0x000000, 0x2F3CBE }); // genderfluid
            pride_flags
                    .add(new int[] { 0xFFF433, 0xFFF8E7, 0x9B59D0, 0x2D2D2D }); // non-binary
            pride_flags
                    .add(new int[] { 0x000000, 0xA3A3A3, 0xFFFFFF, 0x800080 }); // asexual
            pride_flags
                    .add(new int[] { 0x3DA542, 0xA7D379, 0xFFFFFF, 0xA9A9A9, 0x000000 }); // aromantic
            pride_flags.add(new int[] { 0xD60270, 0x9B4F96, 0x0038A8 }); // bisexual
            pride_flags
                    .add(new int[] { 0xD52D00, 0xEF7627, 0xFF9A56, 0xFFFFFF, 0xD162A4, 0xB55690,
                            0xA30262 }); // lesbian
            pride_flags.add(new int[] { 0xFF218C, 0xFFD800, 0x21B1FF }); // pansexual
            pride_flags
                    .add(new int[] { 0x0000FF, 0xFF0000, 0xFFFF00, 0x000000 }); // polyamory
        }
    }
}
